...
const categoryIcon = {
  ...
  people: (props) => <Icon name="mood" {...props} />,
  animals_and_nature: (props) => (
    <Icon name="leaf" type="font-awesome" {...props} />
  ),
              ...
              >
                {_.drop(
                  ...
                  >
                    ...
                    <View
                      style={[
                        styles.underlineSelectedCategory,
                        key === this.state.currentCategoryKey && {
                          backgroundColor: `${this.props.categoryHighlightColor}`,
                        },
                      ]}
                    />
                  </TouchableOpacity>
